        ...
        var that = {
            ...
            switchSection: function (newSection) {
                ...
                sys.eachNode(function (node) {
                	...
                	if(node.name == newSection) return;
                    ...
                    if(newAlpha == 1) {
                        node.p.x = (parent.p.x) + (1 * Math.random() - .025)
                        node.p.y = (parent.p.y) + (1 * Math.random() - .025)
                        node.tempMass = .001
                    }
                })
            },
            ...
            _initMouseHandling: function () {
                ...
                var handler = {
                    moved: function (e) {
                        ...
                        } else if ($.inArray(nearest.node.name, nodeNames) >= 0) {
                    ...
                    clicked: function (e) {
                        ...
                        if (nearest && selected && nearest.node === selected.node) {
                            ...
                            if(selected.node.data.alpha == 0) return;
                            if(!link) return;
                            if (link.match(/^#/)) {
                                $(that).trigger({
                                    type: "navigate",
