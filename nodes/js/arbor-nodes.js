		...
		"kyle j. kemp": 				{color:CLR.root, shape:"dot", alpha:1, alwaysVisible: true}, 
			...
			"r\u00E9sum\u00E9":			{color:CLR.head, shape: "dot", alpha:1, alwaysVisible: true},
				...
				"c#": 					{color:CLR.lang, shape: "dot", alpha: 0},
					"mvc": 				{color:CLR.info,  alpha: 0, isLeaf: true},
					"webforms": 		{color:CLR.info,  alpha: 0, isLeaf: true},
					"webapi": 			{color:CLR.info,  alpha: 0, isLeaf: true},
					"xna": 				{color:CLR.info,  alpha: 0, isLeaf: true},
				...
				"php":					{color:CLR.lang, shape: "dot", alpha: 0},

				"html":					{color:CLR.lang, shape: "dot", alpha: 0},
				...
				"scripting":			{color:CLR.lang, shape: "dot", alpha: 0},
					"bash": 			{color:CLR.info,  alpha: 0, isLeaf: true},
					"batch": 			{color:CLR.info,  alpha: 0, isLeaf: true},
